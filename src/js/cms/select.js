...
(function () {
  ...
  function openEditor(item) {
    ...
    var url = C.PAGES.editor + '?type=' + encodeURIComponent(item.type) + '&id=' + encodeURIComponent(item.id);
    location.href = url;
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if ($('btn-refresh-pages')) {
      $('btn-refresh-pages').onclick = function () { bootPages(); };
    }
